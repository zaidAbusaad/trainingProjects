...
import 'package:grad_project/models/customer_order.dart';
...
class SingleOrderWorkerScreen extends StatelessWidget {
  final CustomerOrderModel data;

  const SingleOrderWorkerScreen({super.key, required this.data});
                ...
                children: [
                  ...
                  _buildDetailCard(
                    children: [
                      _buildDetailItem(
                        icon: Icons.person,
                        title: 'Customer Name',
                        value: customer.name ?? 'No Customer information',
                      ),

                      _buildDetailItem(
                        icon: Icons.phone,
                        title: 'Customer MobileNumebr',
                  ...
                  Row(
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          _showConfirmationDialogOrderDone(context, data.orderId);
                        },
                        style: ElevatedButton.styleFrom(
  ...
  void _showConfirmationDialogOrderDone(BuildContext context, String orderId) {
    showDialog(
      context: context,
